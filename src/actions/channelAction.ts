...
const createChannel = async (data: ChannelData, user: User) => {
...
const updateChannel = async (id: number, data: ChannelData, user: User) => {
  const ability = defineAbilitiesFor(user)
...
const deleteChannel = async (id: number, user: User) => {
  const ability = defineAbilitiesFor(user)
